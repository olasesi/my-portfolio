...
<div class="topbar">
  ...
  <div class="topbar-right">
    <a class="tb-btn tb-btn-primary" href="<?= ADMIN_URL ?>/categories/create.php">+ New Category</a>
  </div>
</div>
  ...
  <div style="display:grid;grid-template-columns:1fr 340px;gap:1.5rem;align-items:start;">
    ...
    <div class="card">
      <div class="card-header">
        <div class="card-title"><?= count($categories) ?> categor<?= count($categories) !== 1 ? 'ies' : 'y' ?></div>
      </div>
      <?php if ($categories): ?>
        <table class="tbl">
          <thead>
