...
<title>400 — Bad Request · Ahmed Olusesi</title>
...
<div class="error-page">
    <div>
        ...
        <h1 class="error-title">Bad <span class="error-accent">request.</span></h1>
        <p class="error-desc">
            The server couldn't understand that request. Try heading back home.
        </p>
